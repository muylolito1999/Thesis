...
df["Mother's qualification"] = df["Mother's qualification"].apply(lambda x: map_values(x, qualification_mapping))
df["Father's qualification"] = df["Father's qualification"].apply(lambda x: map_values(x, qualification_mapping))

# Applica la mappatura alle colonne "Mother's occupation" e "Father's occupation"
df["Mother's occupation"] = df["Mother's occupation"].apply(lambda x: map_values(x, occupation_mapping))
df["Father's occupation"] = df["Father's occupation"].apply(lambda x: map_values(x, occupation_mapping))
